...
parser.add_argument('-o', '--output', help='name for the output file. Can be bigwig or bedgraph', required=True)
parser.add_argument('-p', '--threads', help='Number of threads to use', required=True)
parser.add_argument('-k', '--otherParams', help='Extra parameters to deeptools', action='append', nargs=argparse.REMAINDER)
...
#############################
bamCoverage = "bamCoverage -b " + case + " -o " + output + " -p " + threads + " " + params + " --scaleFactor " + case_norm
