...
parser.add_argument('-o', '--output', help='name for the output bigwig file', required=True)
...
#############################
bamCoverage = "bamCoverage -b " + case + " -o " + output + " --scaleFactor " + dm_norm + " -p " + threads + " " + params
